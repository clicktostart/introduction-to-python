...
So nice we do it twice! In a new file called `pong.py` copy and past the following code. In your editor, follow the instructions to get your first working game!
